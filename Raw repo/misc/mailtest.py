...
root_dir = "C://Users//Cezary//Desktop" #"/home/cezaryrj/IETF/ietf.org/mail-archive/text/"   #"/home/cezaryrj/IETF/ietf.org/mail-archive/text/nat"#os.path.dirname(os.path.realpath(__file__))
file_set = []
...
uploader.upload("http://cezaryrj:solrisnice1337@localhost:8983/solr/IETF_DATABASE_1",database)
